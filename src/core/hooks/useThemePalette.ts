...
const DARK_TOKENS: Record<PaletteId, PaletteTokens> = {
  ...
  slateCyan: {
    ...
    onSecondary:  '10 45 55',
    accent:       '165 243 252',
    gradient:    'linear-gradient(135deg, #475569, #00FFED)',
  },
  pastel: {
    primary:      '190 220 120',
    primaryLight: '220 240 170',
    onPrimary:    '35 45 15',
    secondary:    '134 239 172',
    onSecondary:  '15 45 25',
    accent:       '217 249 190',
    gradient:     'linear-gradient(135deg, #FDE047 0%, #BEF264 50%, #86EFAC 100%)',
  },
}
